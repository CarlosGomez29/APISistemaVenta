        ...
        public AutoMapperProfile()
        {
            ...
            CreateMap<Venta, VentaDTO>()
                ...
                .ForMember(destino =>
                    ...
                    opt => opt.MapFrom(origen => origen.FechaRegistro.Value.ToString("dd/MM/AAA"))
                );
            ...
            CreateMap<DetalleVenta, ReporteDTO>()
                .ForMember(destino =>
                    destino.FechaRegistro,
                    opt => opt.MapFrom(origen => origen.IdVentaNavigation.FechaRegistro.Value.ToString("dd/MM/AAA"))
                )
                .ForMember(destino =>
